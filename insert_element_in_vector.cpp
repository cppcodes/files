...
int main()
{
	...
	copy(vector_of_integers.begin(), vector_of_integers.end(), ostream_iterator<int>(cout, " ")); // 1 3 5 7
	cout << endl << endl;
	...
	for (int i = 0; i < vector_of_integers.size(); i++)
		cout << vector_of_integers.at(i) << ' '; // 1 2 3 4 4 4 4 4 4 4 5 6 7
	cout << endl << endl;
