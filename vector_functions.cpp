...
void print_vector(const vector <int>& vector_of_integers)
{
...
int main()
{
	...
	print_vector(vector_of_integers); // 1 2 3 4 5 6 7
	...
	print_vector(new_vector_of_integers); // 1 2 3 4 5 6 7
	...
	print_vector(vector_of_integers); // 1 3 5 7 9 11
	...
	*p = -3;
	...
	print_vector(vector_of_integers); // -1 -3 -5 -7 -11
	...
	print_vector(vector_of_integers); // -1 -11

	vector_of_integers.swap(new_vector_of_integers); // O(1)
	print_vector(vector_of_integers); // 1 2 3 4 5 6 7
	print_vector(new_vector_of_integers); // -1

	vector_of_integers.pop_back();  // O(1)
	print_vector(vector_of_integers); // 1 2 3 4 5 6
